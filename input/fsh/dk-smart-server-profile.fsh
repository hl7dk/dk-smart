Profile: DKSmartServerProfile
Parent: CapabilityStatement
Id: dk-smart-server-profile
Title: "Danish SMART Server Capability Statement Profile"
Description: "This CapabilityStatement profile describes the basic rules for a server actor providing SMART App Launch in Denmark."
